...
const AddEmployee = () => {
  ...
  const downloadTemplate = () => {
    const csvContent = 'name,email,department,college\nJohn Doe,john@example.com,Computer Science,ABC University\nJane Smith,jane@example.com,Information Technology,XYZ College';
  ...
  const handleSingleSubmit = async (e) => {
    ...
    try {
      setSubmitting(true);
      const response = await api.post('/api/admin/employees', formData);
      
      if (response.data.success) {
        toast.success('Employee created successfully!');
        setFormData({ name: '', email: '', department: '', college: '' });
      }
    } catch (error) {
  ...
  const handleCSVSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post('/api/admin/employees/csv', formDataObj, {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 mt-0.5">Create new employee accounts individually or in bulk</p>
      </div>
            ...
            <form onSubmit={handleCSVSubmit} className="space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-teal-700 bg-teal-50 border border-teal-200 rounded-lg hover:bg-teal-100 transition-colors"
                >
                ...
                <button
                  ...
                  className="w-full px-4 py-2 text-sm font-medium text-white bg-teal-600 rounded-lg hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
              ...
              <div className="flex gap-2">
                ...
                <div className="text-sm text-yellow-700">
                  ...
                  <ul className="list-disc list-inside space-y-0.5 text-xs">
                    <li>Required columns: name, email, department, college</li>
