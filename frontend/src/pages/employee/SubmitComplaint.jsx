...
const EmployeeSubmitComplaint = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.post('/api/employee/complaints', {
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              maxLength={200}
              className={`w-full px-3 py-3 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-teal-500 placeholder:text-gray-400 ${
                errors.subject ? 'border-red-500' : 'border-gray-200'
              }`}
              placeholder="Brief subject of your complaint (e.g., 'Office Equipment Issue')"
              required
            />
            {errors.subject && (
            ...
            <div className="lg:col-span-8">
              <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
                ...
                <textarea
                  ...
                  rows={14}
                  className={`w-full px-3 py-3 border rounded-lg bg-white resize-none focus:outline-none focus:ring-2 focus:ring-teal-500 placeholder:text-gray-400 ${
          ...
          <div className="sticky bottom-0 bg-white/95 backdrop-blur border-t border-gray-200 -mx-4 sm:-mx-6 px-4 sm:px-6 py-3">
            <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
              ...
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-teal-600 text-white text-sm font-medium rounded-lg hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {submitting ? (
                  <>
...
export default EmployeeSubmitComplaint;
